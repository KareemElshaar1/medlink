...
class PasswordResetService {
  ...
  static Future<Map<String, dynamic>> requestResetCode(String email) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://medlink.runasp.net/Auth/doc/request-reset'),
        headers: {
  ...
  static Future<Map<String, dynamic>> resetPassword({
    ...
    try {
      final response = await http.post(
        Uri.parse('http://medlink.runasp.net/Auth/doc/reset-password'),
        headers: {
          'Content-Type': 'application/json',
        },
        body: jsonEncode({
...
class PasswordResetDoctorScreen extends StatefulWidget {
  final VoidCallback? onPasswordResetSuccess;
  final bool isDoctor;

  const PasswordResetDoctorScreen({
    Key? key,
...
class _PasswordResetScreenState extends State<PasswordResetDoctorScreen> {
...
// Usage:
// AnimatedNavigation.navigateToPasswordReset(context);
